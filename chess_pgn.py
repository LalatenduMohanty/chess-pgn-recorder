...
class ChessPGNApp:
    ...
    def preview_and_edit(self) -> bool:
        """
        Show preview and allow editing of moves.
        ...
        edit_input = input("\nWould you like to edit any move? (y/n): ").strip().lower()
        ...
        while True:
            ...
            edit_choice = input(f"Enter move number to edit (1-{move_count}) or 'done' to finish: ").strip()
